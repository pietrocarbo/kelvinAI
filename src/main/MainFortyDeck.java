...
public class MainFortyDeck {
    ...
    private static void playBriscolaAI() {

        BriscolaEngine briscolaEngine = new BriscolaEngine();
        BriscolaAgent briscolaAgent = new BriscolaAgent(briscolaEngine);
        ...
        do {
            ...
            if (briscolaEngine.whoseTurn() == 1) {
                cardSelected = briscolaAgent.makePly();
